...
class SistemaTest {
	...
	void setUp() throws Exception {
		...
		usuario1 = sistema1.registrarUsuario("alberto", "calle 1", 1111);
		usuario2 = sistema1.registrarUsuario("benito", "calle 2", 2222);
		propiedad1 = sistema1.registrarPropiedad(usuario1, "Catedral", "es hermosa", 100);
