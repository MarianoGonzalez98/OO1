...
public class Sistema {
	...
	public Propiedad registrarPropiedad(Usuario propietario,String nombre, String descripcion, double precio) {
		Propiedad propiedad = new Propiedad(nombre, precio, descripcion);
